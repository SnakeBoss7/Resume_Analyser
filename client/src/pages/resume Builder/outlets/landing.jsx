import { FaArrowRight, FaBold, FaBrain, FaBullseye, FaChartLine, FaCheckCircle, FaClock, FaFileAlt, FaHome, FaMagic, FaMedal, FaPlus, FaStar, FaStarOfDavid, FaUpload, FaUsers } from "react-icons/fa";
      ...
      <div className="mb-10 px-5 starters items-center flex flex-col lg:flex-row gap-5 lg:px-32 justify-center">
        ...
        <div className="rounded-2xl w-[300px] h-[550px] pack py-6 px-5 flex flex-col gap-7 items-center shadow-xl hover:-translate-y-2 hover:shadow-gray-400 transition-all ease-in-out duration-400 bg-white">
          ...
          <div className="heading w-full">
            <h2 className="text-3xl mb-2 text-center font-bold tracking-tight">
              Create From scratch
            </h2>
          ...
          {[
            ...
            <div
              key={i}
              className="flex items-center gap-3 text-gray-900 tracking-tight text-zinc-800 text-left font-bold text-md w-full"
            >
        ...
        <Link
          to="enhancer"
          className="rounded-2xl w-[350px] h-[600px] pack py-6 px-5 flex flex-col gap-7 items-center shadow-xl hover:-translate-y-2 hover:shadow-gray-400 transition-all ease-in-out duration-400 bg-white"
        >
        ...
        <div class="w-full h-[90%] text-white flex flex-col lg:gap-0 gap-10   lg:justify-between p-5 lg:items-center md:flex-row  rounded-xl h-fit bg-gradient-to-r from-primary via-blue-700 to-purple-600 ">
          <div class="left lg:w-1/2">
            ...
            <div className="flex items-center gap-3 text-lg">
              {" "}
              <FaBold /> Real-time ATS compatibility scoring
            </div>
            <div className="flex items-center gap-3 text-lg">
              {" "}
            ...
            <div className="flex items-centScratcher gap-3 text-lg">
              {" "}
