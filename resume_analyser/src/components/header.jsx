    ...
    >
      <div className=" mx-auto container w-full flex justify-between ">
        ...
        <div className="right flex items-center gap-5">
          ...
          <button className="text-bg_c font-bold border  border-bg_c  px-4 py-2 rounded-md  hover:bg-gradient-to-r hover:from-blue-500 hover:via-blue-500 hover:to-purple-600 hover:text-white hover:border-white">
            Sign In
          </button>
